...
export function atualizarBotaoLimpar(lista, botao) {
  const temItens = lista.querySelectorAll('li:not(.placeholder)').length > 0;
  botao.disabled = !temItens;

  if (!temItens && !lista.querySelector('.placeholder')) {
